            ...
            <div>
                ...
                <div className="row">
                    ...
                    <div className="col-sm-6">
                        ...
                        <p className="descripcion">Además de crear o editar una historia Books te permite comentar una historia además de darle like a tus historias favoritas. Como invitado solo podrás ver las historias existentes. Inicia sesión para disfrutar de todas las funcionalidades </p>
                    </div>
                </div>
                <br/><br/><br/>
                <div className="row">
